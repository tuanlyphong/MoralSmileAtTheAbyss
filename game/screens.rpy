...
# Define the fly-in animation transform with a fade-in effect
# Define a transform with a delay for sequential fade-in
transform fade_in_with_delay(duration=0.5, delay=0.0):
    alpha 0.0
    pause delay  # Wait before starting the fade-in
    linear duration alpha 1.0  # Fade in over the specified duration

screen navigation():
    hbox:
        style_prefix "navigation"
        
        xpos 0.221  # Position horizontally (adjust as needed)
        yalign 0.6  # Position vertically
