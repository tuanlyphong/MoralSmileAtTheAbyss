...
define f = Character("Fu",window_style="window",ctc="ctc_animation",who_color="#ffffff",ctc_position="fixed")
define y0 = Character(" Yuka ",window_style="window", who_color="#ffffff",ctc_position="fixed",ctc="ctc_animation")
